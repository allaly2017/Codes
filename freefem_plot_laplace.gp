...
set title "Equation de Laplace avec u(x,y)=sin(2*pi*x)*sin(2*pi*y), r=3"
set key bottom right

set output "output/laplace_errors_umfpack.pdf"
plot [0.001:0.2] "output/laplace_errors_umfpack.txt" u 1:2 w lp ls 1 t 'Norme L^2', "output/laplace_errors_umfpack.txt" u 1:3 w lp ls 1 t 'Norme H^1'
#replot[0.001:0.2] "output/laplace_errors_umfpack.txt" u 1:3 w lp ls 2 t 'Norme H^1'

set output "output/laplace_cpu.pdf"
set ylabel "temps (s)"
set key top right
plot [0.001:0.2] \
     "output/laplace_errors_umfpack.txt" u 1:4 w lp ls 1 t 'temps CPU -- UMFPACK, r=3',  "output/laplace_errors_umfpack.txt" u 1:5 w lp ls 1 t 'temps CPU -- GMRES, r=3',  "output/laplace_errors_umfpack.txt" u 1:6 w lp ls 1 t 'temps CPU -- CG, r=3' 
